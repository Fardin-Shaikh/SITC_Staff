...
import 'package:upcomming/screens/billing/showbillingdetails.dart';
...
class _BillingState extends State<Billing> {
  ...
  Widget Listview_widget(UpcommingRecord respo) {
    ...
    if (data.length == 0) {
      return Center(
          child: dec_text(context, 'Not Billing  List ', Acolors.dark_bround,
              FontWeight.bold, 2));
    }
    return Container(
          ...
          itemBuilder: (BuildContext ctxt, int index) {
            ...
            switch (data[index].todaystafforder.checkingStatus) {
              ...
              case '2':
                ...
                break;
              default:
                return main_card(respo, index, ' ', Colors.white, true);
            }
          }),
    );
  }
                            ...
                            children: [
                              ...
                              Container(
                                  ...
                                  child: Row(
                                      ...
                                      children:
                                          // (data[index].cartList[i].typeName == 'ShootPackages' || data[index].cartList[i].typeId == 'BeautifulOutfits'||data[index].cartList[i].typeId == 'FoodAndBeverages'||data[index].cartList[i].typeId == 'LuxuryStay') ?true:false
                                          [
                                        crv(
                                            alfa[0],
                                            data[index]
  ...
  Future<void> billing(String api_name) async {
